...
{
    public class GymBuddyContext : IdentityDbContext<ApplicationUser>
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=GymBuddy;Trusted_Connection=True;");
